...
start "Backend API" cmd /k cd /d "%~dp0unified-backend" ^& set PORT=5001 ^& set FRONTEND_URLS=http://localhost:5173,http://localhost:5174,http://localhost:5175 ^& npm run dev
